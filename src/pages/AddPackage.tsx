...
const AddPackage = () => {
    ...
    const onDeleteCoverImage = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, imgLink: string) => {
        event.preventDefault()
        const imgName = imgLink.replace(
            `${import.meta.env.VITE_APP_UPLOAD_URL || 'https://upload.digitalauto.tech/'}data`,
            ''
        )
        setimageCover('')
        try {
    ...
    const onDeleteZipFile = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        event.preventDefault()
        const fileDeleteName = fileZipName.replace(
            `${import.meta.env.VITE_APP_UPLOAD_URL || 'https://upload.digitalauto.tech/'}data`,
            ''
        )
        try {
    ...
    const onDeleteDetailImage = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, index: number) => {
        ...
        const imgDeleteName = imgDelete.replace(
            `${import.meta.env.VITE_APP_UPLOAD_URL || 'https://upload.digitalauto.tech/'}data`,
            ''
        )
        try {
            ...
            <div className='flex justify-center pt-[46px]'>
                <form className='sm:w-[60%] w-[90%] p-5 bg-white'>
                            ...
                            <div className='mt-2 grid grid-cols-1 gap-x-6 gap-y-1 sm:grid-cols-2'>
                                    ...
                                    <div className='sm:w-[50%] w-[100%] flex justify-end'>
                                        <div className='sm:w-[95%] w-full'>
                                            <TextInput
                                                ...
                                                value={packageShortDesc}
                                                placeholderStr='Write one sentence about your package'
                                                handleFileTextChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                                                    setPackageShortDesc(event.target.value)
                                                }
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className='w-[100%]'>
                                        <div className='sm:w-[95%] w-full'>
                                            <TextArea
                                                ...
                                                placeHolderStr='Write some sentences about your package'
                                ...
                                <div className='col-span-full flex'>
                                    <div className='w-[50%]'>
                                        <CategorySelect
                                            defaultVal='widget'
                                            listCategory={_const.categoryFake}
                                            handleChangeCategory={(value: string) => setCategory(value)}
                                        />
                                    </div>
                                ...
                                {category === 'genai' && (
                                    <div className='col-span-full sm:flex items-center'>
                                        <div className='sm:w-[50%] w-[100%]'>
                                            <CategorySelect
                                                label='Sub-Category'
                                                defaultVal='GenAI_Widget'
                                                listCategory={_const.categoryGenAI}
                                                handleChangeCategory={(value: string) => setGenAIType(value)}
                                            />
                                        </div>
                                        ...
                                        <div className='col-span-full flex'>
                                            <div className='w-[100%]'>
                                                <TextInput
                                                    title='Entry point'
                                                    value={entryPoint}
                                                    placeholderStr='Enter file name you want to demo'
                                                    handleFileTextChange={(
                                ...
                                <div className='my-4 images-container sm:grid sm:grid-cols-2 lg:grid-cols-3 col-span-full sm:justify-between'>
                                    {imageDetailList &&
                                        imageDetailList.length > 0 &&
                                        imageDetailList.map((base64, index) => (
                                            <ImageDetailView
                                                index={index}
                                                base64={base64}
                                ...
                                {category !== 'genai' && (
                                    <>
                                        <UploadFile
                                            ...
                                            onDeleteZipFile={onDeleteZipFile}
                                        />
                                        ...
                                        <div className='col-span-full'>
                                            <TextInput
                                                ...
                                                handleFileTextChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                                                    setLinkSourceCode(event.target.value)
                                                }
                                            />
                                        </div>
                                    ...
                                    <>
                                        <div className='col-span-full'>
                                            <TextInput
                                                ...
                                                value={linkGenAIUrl}
                                                handleFileTextChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                                                    setLinkGenAIUrl(event.target.value)
                                                }
                                            />
                                        </div>
                                        ...
                                        <div className='col-span-full'>
                                            <TextInput
                                                ...
                                                value={genAIToken}
                                                handleFileTextChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                                                    setGenAIToken(event.target.value)
                                                }
                                            />
                                        </div>
                                        ...
                                        <div className='col-span-full'>
                                            ...
                                            <Editor
                                                ...
                                                defaultLanguage=''
                                                defaultValue={``}
                                                value={genAISampleCode}
                                                onChange={(value) => setGenAISampleCode(value?.trim() || '')}
                                            />
                                        </div>
                                    </>
                                )}
                    ...
                    <div className='mt-6 flex items-center justify-end gap-x-6'>
                        <CustomButton title='Go back' onClickBtn={() => navigate('/')} bgColor='bg-gray-400' />
