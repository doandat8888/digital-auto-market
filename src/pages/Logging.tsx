                ...
                {loggingList && loggingList.length > 0 && loggingList.map((logging) => (
                    <tr>
                        ...
                        <td className="items-center border-t-0 px-2 sm:px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap sm:p-4 py-2">
                            <a href={logging.timestamp} className="py-2 flex text-white items-center justify-center cursor-pointer rounded bg-blue-400"><BiDownload /><p className="lg:block lg:ml-2 hidden">Download</p></a>
                        </td>
                    </tr>
                ))
                }
