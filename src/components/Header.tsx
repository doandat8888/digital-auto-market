...
const Header = () => {
    ...
    return (
        <div className={`${isLoading ? 'hidden' : ''} fixed bg-white z-50 w-full`}>
                    ...
                    <div className="text-black flex items-center">
                        {user ?
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024"
                                className='sm:mx-0 mx-4' height="22" width="22" xmlns="http://www.w3.org/2000/svg">
