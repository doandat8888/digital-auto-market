...
const PackageItem = (props: IProps) => {
    ...
    return (
        <Link to={`/package/${packageItem._id}?version=latest`} className='w-[90%] mx-auto py-4 my-4 bg-[#eff2ef] rounded-2xl hover:bg-[#e3e3e3] shadow-md'>
            <div className="leftmx-auto">
            ...
            <div className="custom-link flex px-5 mt-4 cursor-pointer rounded">
                {/* <div className="left sm:w-[10%] lg:w-[10%] w-[10%] xl:w-[10%] min-w-[80px]">
