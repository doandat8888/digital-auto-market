                ...
                <tbody>
                    {versionList && versionList.length > 0 && versionList.map((version) => (
                        <tr>
                            ...
                            <td className="sm:block hidden border-t-0 px-2 sm:px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap py-2 sm:p-4 text-left text-blueGray-700 ">
